...
const GetDetails=(id,type,page,n)=>`https://www.jiosaavn.com/api.php?__call=webapi.get&token=${id}&type=${type}&p=${page}&n=${n}&n_song=${n}&includeMetaTags=0&ctx=wap6dot0&api_version=4&_format=json&_marker=0`
